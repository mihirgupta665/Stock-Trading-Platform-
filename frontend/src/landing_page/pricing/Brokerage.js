    ...
    return (
        <div className="container border-top mt-4 p-5">
            <div className="row  p-3">
                <div className="col-8 ">
                    <a style={{ textDecoration: "None" }} href="https://zerodha.com/charges#tab-equities"><h4 className="text-center ">Brokerage Calculator</h4></a>
                ...
                <div className="col-4">
                    <a style={{ textDecoration: "None" }} href="https://zerodha.com/charges"><h4 className="text-center">List of Charges</h4></a>
                </div>
            </div>
        </div>
    );
