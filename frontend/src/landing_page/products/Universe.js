    ...
    return (
        <div className="container my-5 p-5 text-center">
            ...
            <div style={{ fontSize: "13px" }} className="row text-muted mt-4 ms-1 pt-5 ">
                ...
                <div className="col-4">
                    <img style={{ width: "40%" }} src="media/images/streakLogo.png" alt="Streak Logo" />
            ...
            <div style={{ fontSize: "13px" }} className="row text-muted ms-1 pt-5 ">
                <div className="col-4">
                    <img style={{ width: "50%" }} src="media/images/zerodhaFundhouse.png" alt="Zerodha Fundhouse Logo" />
                    <p className="text-small text-muted px-5 pt-1 mt-3">Systematic trading platform
                        that allows you to create and backtest
                        strategies without coding.</p>
                </div>
                <div className="col-4">
                    <img style={{ width: "55%" }} src="media/images/goldenpiLogo.png" alt="Golden Pi Logo" />
                    <p className="text-small text-muted px-5 mt-3">Thematic investing platform
                        that helps you invest in diversified
                        baskets of stocks on ETFs.</p>
                </div>
                <div className="col-4">
                    <img style={{ width: "35%" }} src="media/images/dittoLogo.png" alt="Ditto Logo" />
