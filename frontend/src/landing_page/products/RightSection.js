        ...
        <div className="container py-5">
            <div className="row align-items-center">
                <div className="col-12 col-md-6 order-2 order-md-1 p-3">
                    ...
                    <a style={{textDecoration:"None"}} href={process.env.REACT_APP_DASHBOARD_URL || (window.location.hostname === "localhost" ? "http://localhost:3001" : "")}>{arrowName} <i className="fa-solid fa-arrow-right-long"></i> </a>
                </div>
