        ...
        <div className="container p-5">
            <div className="row px-5">
                <div className="col-6 mt-5 p-5">
                    ...
                    <a style={{textDecoration:"None"}} href="http://localhost:3001">{arrowName} <i className="fa-solid fa-arrow-right-long"></i> </a>
                </div>
                <div className="col-6">
                    <img src={imageURL} alt={productName} style={{height:"110%", width:"120%"}}></img>
                </div>
            </div>
        </div>
     );
